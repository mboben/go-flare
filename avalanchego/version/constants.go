...
var (
	...
	BanffTimes = map[uint32]time.Time{
		...
		constants.FlareID:      time.Date(2023, time.December, 22, 0, 0, 0, 0, time.UTC),
		constants.CostwoID:     time.Date(2023, time.December, 22, 0, 0, 0, 0, time.UTC),
		constants.StagingID:    time.Date(2023, time.December, 22, 0, 0, 0, 0, time.UTC),
		constants.LocalFlareID: time.Date(2023, time.December, 22, 0, 0, 0, 0, time.UTC),
	}
